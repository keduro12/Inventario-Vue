<template>
    ...
    <div class="page-content">
        <main>
            ...
            <p id="errorText">Parece que la pagina que querias visitar no exite.</p>
            <button type="button" id="errorLink" class="btn btn-dark" @click="back()">Back</button>
            <!-- <button type="button" id="errorLink" class="btn btn-dark"><router-link to="/home">Home</router-link></button> -->
        </main>
    </div>
</template>
